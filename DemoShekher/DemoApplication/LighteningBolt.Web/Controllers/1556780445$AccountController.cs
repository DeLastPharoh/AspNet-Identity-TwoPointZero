...
using LighteningBolt.Application.Services;
using LighteningBolt.Core.Entities.Authentication;
using LighteningBolt.Web.Models.AccountViewModels;
...
namespace LighteningBolt.Web.Controllers
{
    [Authorize]
//    [Area("Identity")]
    public class AccountController : Controller
    {
        ...
        public IActionResult Register(string returnUrl = null)
        {
            ...
            model.Roles = _roleManager.Roles.Select(x => new SelectListItem { Text=x.Name, Value=x.Name }).ToList();
                return View(model);
        }
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //bool x = await _roleManager.RoleExistsAsync("Coach");
                    //if (!x)
                    //{
                    ...
                    //    user1.UserName = "default";
                    //    user1.Email = "default@default.com";
                    ...
                    //    }
                   // }
                    var roleresult = await _userManager.IsInRoleAsync(currentUser,  model.Role );
